...
- C++로 구현한 머신 러닝
  - [(241217)드디어 올라옴 이걸 러스트 코드로 만들면 대박이요 ㅋㅋ**[GN⁺: C++와 CUDA를 사용하여 처음부터 LLM 추론 엔진 만들기](<https://news.hada.io/topic?id=18295&utm_source=discord&utm_medium=bot&utm_campaign=1480>)**](#241217드디어-올라옴-이걸-러스트-코드로-만들면-대박이요-ㅋㅋgn-c와-cuda를-사용하여-처음부터-llm-추론-엔진-만들기)
